...
<!--      <el-form-item label="班级：" prop="gradeLevel" required>
        <el-select v-model="form.gradeLevel" placeholder="班级"  @change="levelChange">
          <el-option v-for="item in levelEnum" :key="item.key" :value="item.key" :label="item.value"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="班级：" prop="subjectId" required>
        <el-select v-model="form.subjectId" placeholder="班级" >
...
export default {
  ...
  computed: {
    ...
    ...mapState('exam', { subjects: state => 1 })
  }
}
</script>
