<template>
  <div class="lowin  lowin-blue">
    <div class="lowin-brand">
      <img src="@/assets/logo2.jpeg" alt="logo" style="margin-top: 12px">
    </div>
        ...
        <div class="lowin-box-inner">
          <el-form ref="loginForm" :model="loginForm">
            ...
            <div class="lowin-group">
              <label>用户名 </label>
              <el-input ref="userName" v-model="loginForm.userName" class="lowin-input" placeholder="学号"
            ...
            <div class="lowin-group">
              <label>班级 </label>
              <el-select class="lowin-input" v-model="loginForm.userLevel" placeholder="班级">
    ...
    <div class="account-foot-copyright">
      <span>Copyright © 2022 Designed by zhaoosn</span>
    </div>
  </div>
</template>
