<template>
  <div class="lowin  lowin-blue">
    <div class="lowin-brand">
      <img src="@/assets/logo2.jpeg" alt="logo" style="margin-top: 14px; object-fit: fill">
    </div>
                ...
                <el-col :span="6">
                  <div class="grid-content bg-purple">
                    <el-popover
                      ...
                      trigger="click"
                      content="请联系老师修改密码~">
                      <el-button slot="reference" size="mini" type="text" style="color: #6bb5c9" >忘记密码?</el-button>
                    </el-popover>
                  </div></el-col>
              </el-row>
