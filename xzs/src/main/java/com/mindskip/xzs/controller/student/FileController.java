...
import com.mindskip.xzs.mapper.FileMapper;
...
public class FileController {
    ...
    //redis
    private static final String FILES_KEY = "FILES_FRONT_ALL";
    ...
    public String upload(@RequestParam MultipartFile file) throws IOException {
        ...
        if (dbFiles != null) {
            ...
            url = "http://" + serverIp + ":8001/file/" + fileUUID;
        }
...
//        setCache(Constants.FILES_KEY, JSONUtil.toJsonStr(files));
    ...
    @PostMapping("/update")
    public RestResponse update(@RequestBody Files files) {
    ...
    public RestResponse getById(@PathVariable Integer id) {
        return RestResponse.ok(fileMapper.selectById(id));
    }
...
//    @CacheEvict(value="files",key="'frontAll'")
    ...
    public RestResponse findPage(@RequestParam Integer pageNum,
        ...
        return RestResponse.ok(fileMapper.selectPage(new Page<>(pageNum, pageSize), queryWrapper));
    }
